...
% Temporal intervals
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T       = 40; %Simulation time in milliseconds
...
Is(M,:) = 100;  %Current Stimulation starting in the middle of the axon 
...
subplot(2,1,1);
plot(t,vm(M+3,:));
title('Multiple AP''s indicating the max firing rate.');
...
ylim([0,2100]);
title('AP propagation of AP''s at max firing rate.');
