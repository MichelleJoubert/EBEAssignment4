...
%single anodic monophasic stimulation pulse. The simulation shows how the
%propagation pattern appears later when the amplitude aproaches the
%treshold.
...
ylim([-100,5100]);
title('AP propagation with z = 0.05 cm and A = 6 mA/cm^2');
xlabel('Distance along the axon [cm].');

subplot(2,2,3)
plot(x,f_e(:,1));
title('Activation function with z = 0.05 cm and with A = 6 mA/cm^2');
xlabel('Distance along the axon [cm].');
...
ylim([-100,5100]);
title('AP propagation with z = 0.05 cm and A = 2.9 mA/cm^2');
xlabel('Distance along the axon [cm].');

subplot(2,2,4)
plot(x,f_e(:,1));
title('Activation function with z = 0.05 cm and with A = 2.9 mA/cm^2');
xlabel('Distance along the axon [cm].');
