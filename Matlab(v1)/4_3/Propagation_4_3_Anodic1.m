...
%single anodic monophasic stimulation pulse. The simulation shows the
%difference in the propagation pattern when z = 0.05 cm and z = 0.1 cm at a
%higher amplitude.
...
ylim([-100,5100]);
title('AP propagation with z = 0.1 cm and A = 48 mA/cm^2');
xlabel('Distance along the axon [cm].');

subplot(2,2,4)
plot(x,f_e(:,1));
title('Activation function with z = 0.1 cm and with A = 48 mA/cm^2');
xlabel('Distance along the axon [cm].');
