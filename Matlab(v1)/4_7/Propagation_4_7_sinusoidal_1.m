...
A       = 196; %Amplitude of stimulation
f1      = 461; %In Hz
...
figure(1);
subplot(2,1,1);
plot(t,vm(M,:),t,0.25*Is(M,:),'--');
title('Sinusoidal input with F = 461 Hz');
...
ylim([0, 2100]);
title('AP propagation with a sinusoidal input at F = 461 Hz');
xlabel('Simulation time [ms]');
