function [Done] = MultiVar4_6(Distance, I, Idur)
...
%   
%   Example:
%   MultiVar4_3([0.095,0.055,0.025,0.018],-4.5) for cathodic stimulation
%   MultiVar4_6([0.055],10,10) for anodic stimulation
%   MultiVar4_6([0.01],15,5000)
%
%%	Simulation timing variables
    t = 0;
    loop = 0;
    dt = 0.01;
    tspan = 500; %400 for full prop to end of fibre
...
%%  Running through the various input diameters 
    for i=1:length(Distance)
        ...
        [data,m,h,n,Ispan] = HHsim(Distance1,I,Idur,t,x,loop,xloop,dx);
        dataholder{1,i} = data;
    end
...
function [V,t,m,h,n,Ispan] = HHsim(z,defI,defIdur,t,x,loop,xloop,dx)    
