function [Done] = MultiVar4_4(Distance, I)
...
%   
%   Example:
%   MultiVar4_4([0.025],1000) for bipolar stimulation with anode then
%   cathode placed along fibre 
%   MultiVar4_4([0.025],2000)for bipolar stimulation with cathode then
...
%%  Running through the various input diameters 
    for i=1:length(Distance)
        ...
        [data,t,m,h,n,Ispan] = HHsim(Distance1,I,t,x,loop,xloop,dx);
        dataholder{1,i} = data;
    end
...
%         end
        freq1 = 2; 
        freq2 = 200; %12.5
        Ispan(2,:) = defI*sin(2*pi*freq1*(10^(-3))*t);
        Ispan(20,:) = 200*defI*sin(2*pi*freq2*(10^(-3))*t);
